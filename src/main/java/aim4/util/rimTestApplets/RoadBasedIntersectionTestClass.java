...
public class RoadBasedIntersectionTestClass extends JPanel {
    ...
    public static void main(String[] args) {
		JFrame frame = new JFrame("RoadBasedIntersectionTestClass");
		frame.add(new RoadBasedIntersectionTestClass());
