...
import aim4.vehicle.rim.ProxyVehicle;
 ...
 */
public class RIMUdpListener implements Runnable{
    /////////////////////////////////
    // CONSTANTS
    /////////////////////////////////
    ...
    /** the simulator */
    private final RIMSimulator sim;
     ...
     */
    public RIMUdpListener(RIMSimulator sim) {
     ...
     * @param sim      the simulator
     */
    public RIMUdpListener(int udpPort, RIMSimulator sim) {
...
//    }
    ...
    private ProxyVehicleSimModel makeProxyVehicle(Real2ProxyPVUpdate msg) {
        ProxyVehicleSimModel vehicle = new ProxyVehicle(msg.position,
                ...
                msg.acceleration,
                msg.receivedTime);
        vehicle.setDriver(new ProxyDriver(vehicle, (BasicRIMIntersectionMap) sim.getMap()));
